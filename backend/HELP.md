...
* The original package name 'com.indentity.identity-app' is invalid and this project uses 'com.indentity.identity_app' instead.
...
* [Spring Data Redis (Access+Driver)](https://docs.spring.io/spring-boot/3.4.12/reference/data/nosql.html#data.nosql.redis)
